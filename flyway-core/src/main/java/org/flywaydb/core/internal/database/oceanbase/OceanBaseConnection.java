...
public class OceanBaseConnection extends Connection<OceanBaseDatabase> {
    OceanBaseConnection(OceanBaseDatabase database, java.sql.Connection connection) {
    ...
    public Schema getSchema(String name) {
        return new OceanBaseSchema(jdbcTemplate, database, name);
    }
}