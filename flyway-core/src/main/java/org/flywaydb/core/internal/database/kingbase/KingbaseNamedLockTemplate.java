...
/**
 * Spring-like template for executing with Kingbase named locks.
 */
@CustomLog
public class KingbaseNamedLockTemplate {
    /**
     ...
     */
    KingbaseNamedLockTemplate(JdbcTemplate jdbcTemplate, int discriminator) {
