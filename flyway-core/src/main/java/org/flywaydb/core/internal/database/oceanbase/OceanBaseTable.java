...
import org.flywaydb.core.internal.database.oceanbase.OceanBaseSchema;
 ...
 */
public class OceanBaseTable extends Table<OceanBaseDatabase, OceanBaseSchema> {
    /**
     ...
     */
    public OceanBaseTable(JdbcTemplate jdbcTemplate, OceanBaseDatabase database, OceanBaseSchema schema, String name) {
